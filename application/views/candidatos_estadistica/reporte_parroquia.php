...
<div class="container pt-5">
    ...
    <div class="w-100" style="overflow-x: auto;">
        ...
        <?php else : ?>
                ...
                <div class="pb-3">
                    <a href="<?php echo site_url("candidatos_estadistica/reporte_candidatos_por_parroquia") ?>" class="float-right btn btn-success">Exportar reporte</a>
                </div>
            <br><br>

            <?php $this->load->view("candidatos_estadistica/tablas/parroquia", [
